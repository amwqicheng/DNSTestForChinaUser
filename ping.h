...
public:
    CPing();
    ~CPing();
    BOOL Ping(DWORD dwDestIP, PingReply* pPingReply = NULL, DWORD dwTimeout = 460);
    BOOL Ping(const char* szDestIP, PingReply* pPingReply = NULL, DWORD dwTimeout = 460);
private:
